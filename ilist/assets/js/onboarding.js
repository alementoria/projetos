...
(function DyListOnboarding() {
  ...
  const STEPS = [
    {
      targetSel : '.btn-tutoriais',   // botão Tutoriais na barra de controles
      side      : 'bottom',
      arrowSide : 'top',
      icon      : '🎓',
      text      : 'Comece aprendendo. Use todas as ferramentas em 3 minutos.',
    },
    {
      targetSel : '#openCategoriesBtn',
      side      : 'bottom',
      arrowSide : 'top',
      icon      : '📁',
      text      : 'Crie uma categoria para organizar seus vídeos.',
    },
    {
      targetSel : '.url-input-wrapper',
      side      : 'bottom',
      arrowSide : 'top',
      icon      : '🔗',
      text      : 'Pesquise por nome, tema, canal — ou cole um link do YouTube.',
    },
    {
      targetSel : '#playlistContainer',
      side      : 'top',
      arrowSide : 'bottom',
      icon      : '▶️',
      text      : 'Selecione o que deseja reproduzir e aproveite sem distrações!',
    },
  ];
