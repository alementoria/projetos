...
class TutorialSidebar {
  ...
  createSidebar() {
    ...
    footer.innerHTML = `
      <div id="sb_apiKeySection">
        <button id="sb_toggleApiKeyBtn" style="
          width: 100%;
          background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
          color: #fff;
          border: none;
        ...
        <div id="sb_apiKeyForm" style="display:none; margin-top: 12px;">
          <input
            id="sb_apiKeyInput"
            type="password"
          ...
          <div style="display:flex; gap:8px;">
            <button id="sb_saveApiKeyBtn" style="
              flex: 1;
              background: #10b981;
              color: #fff;
              border: none;
              ...
              cursor: pointer;
            ">✅ Substituir</button>
            <button id="sb_cancelApiKeyBtn" style="
              flex: 1;
              background: rgba(255,255,255,0.1);
              color: #94a3b8;
              border: none;
          ...
          <div id="sb_apiKeyMsg" style="display:none; margin-top:8px; font-size:12px; color:#10b981; text-align:center;">✅ Chave salva com sucesso!</div>
        </div>
      </div>
    `;
    ...
    setTimeout(() => {
      const toggleBtn  = document.getElementById('sb_toggleApiKeyBtn');
      const form       = document.getElementById('sb_apiKeyForm');
      const saveBtn    = document.getElementById('sb_saveApiKeyBtn');
      const cancelBtn  = document.getElementById('sb_cancelApiKeyBtn');
      const input      = document.getElementById('sb_apiKeyInput');
      const msg        = document.getElementById('sb_apiKeyMsg');
      ...
      if (saveBtn) saveBtn.addEventListener('click', () => {
        ...
        // Sincroniza com a instância do SmartSearch imediatamente
        if (window.smartSearchInstance) {
          window.smartSearchInstance.API_KEY = key;
        }
